...
const IndustryExperienceForm = () => {
  const [experiences, setExperiences] = useState(
   localStorage.getItem("multiplIndustryExp")==null? [{
    institute: '',
    designation: '',
    from: '',
    to: '',
...
console.log(experiences)
  const handleInputChange = (index, event) => {
    ...
    localStorage.setItem("multiplIndustryExp",JSON.stringify(newExperiences))
  ...
  const addExperience = () => {
    ...
    setExperiences(temp);
      ...
      localStorage.setItem("multiplIndustryExp",JSON.stringify(temp))
  };
